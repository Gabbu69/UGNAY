...
public final class UiContracts {
    ...
    public record HealthView(String id, String label, Double score, double delta, String detail) {}
    ...
    public record WorkspaceView(CurrentUser currentUser, ProjectSummary project, List<ProjectSummary> projects,
                                ...
                                List<ReviewView> reviewQueue, List<LineageView> lineage, Instant generatedAt) {}
    public record DiscoveryView(UUID id, AssessmentStatus status, Recommendation recommendation,
                                double confidence, List<StudyView> candidates, String algorithmVersion) {}
}
